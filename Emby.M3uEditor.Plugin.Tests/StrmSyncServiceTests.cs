...
namespace Emby.M3uEditor.Plugin.Tests
{
    public class StrmSyncServiceTests
    {
        ...
        {
            var a = new List<Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo>
            {
                new Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo { StreamId = 1, Name = "BBC One", EpgChannelId = "bbc1", CategoryId = 10 },
                new Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo { StreamId = 2, Name = "ITV",     EpgChannelId = "itv",  CategoryId = 10 },
            };
            var b = new List<Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo>
            {
                new Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo { StreamId = 2, Name = "ITV",     EpgChannelId = "itv",  CategoryId = 10 },
                new Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo { StreamId = 1, Name = "BBC One", EpgChannelId = "bbc1", CategoryId = 10 },
            };
        ...
        public void ComputeChannelListHash_NumChange_DifferentHash()
        {
            ...
            var a = new List<Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo>
            {
                new Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo { StreamId = 1, Name = "BBC One", EpgChannelId = "bbc1", CategoryId = 10, Num = 1 },
            };
            var b = new List<Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo>
            {
                new Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo { StreamId = 1, Name = "BBC One", EpgChannelId = "bbc1", CategoryId = 10, Num = 2 },
            };
        ...
        public void ComputeChannelListHash_StreamIconChange_DifferentHash()
        {
            ...
            var a = new List<Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo>
            {
                new Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo { StreamId = 1, Name = "BBC One", StreamIcon = "https://logos/bbc-old.png" },
            };
            var b = new List<Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo>
            {
                new Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo { StreamId = 1, Name = "BBC One", StreamIcon = "https://logos/bbc-new.png" },
            };
            Assert.NotEqual(StrmSyncService.ComputeChannelListHash(a), StrmSyncService.ComputeChannelListHash(b));
        }
        ...
        public void ComputeChannelListHash_NullStreamIcon_StableAcrossCalls()
        {
            ...
            var channels = new List<Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo>
            {
                new Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo { StreamId = 1, Name = "X", StreamIcon = null, Num = 0 },
            };
        ...
        public void ComputeChannelListHash_NameChange_DifferentHash()
        {
            ...
            var b = new List<Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo>
            {
                new Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo { StreamId = 1, Name = "BBC One HD" },
            };
            Assert.NotEqual(StrmSyncService.ComputeChannelListHash(a), StrmSyncService.ComputeChannelListHash(b));
        }
        ...
        {
            var h1 = StrmSyncService.ComputeChannelListHash(new List<Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo>());
            var h2 = StrmSyncService.ComputeChannelListHash(new List<Emby.M3uEditor.Plugin.Client.Models.LiveStreamInfo>());
            Assert.Equal(h1, h2);
            Assert.NotEmpty(h1);
        }
        ...
        {
            var a = new Dictionary<string, List<Emby.M3uEditor.Plugin.Client.Models.EpisodeInfo>>
            {
                ["1"] = new List<Emby.M3uEditor.Plugin.Client.Models.EpisodeInfo>
                {
                    new Emby.M3uEditor.Plugin.Client.Models.EpisodeInfo { Id = 101, Season = 1, EpisodeNum = 1, ContainerExtension = "mp4" },
                    new Emby.M3uEditor.Plugin.Client.Models.EpisodeInfo { Id = 102, Season = 1, EpisodeNum = 2, ContainerExtension = "mp4" },
                }
            };
            var b = new Dictionary<string, List<Emby.M3uEditor.Plugin.Client.Models.EpisodeInfo>>
            {
                ["1"] = new List<Emby.M3uEditor.Plugin.Client.Models.EpisodeInfo>
                {
                    new Emby.M3uEditor.Plugin.Client.Models.EpisodeInfo { Id = 102, Season = 1, EpisodeNum = 2, ContainerExtension = "mp4" },
        ...
        public void ComputeSeriesEpisodeHash_DifferentEpisodeId_DifferentHash()
        {
            ...
            var b = new Dictionary<string, List<Emby.M3uEditor.Plugin.Client.Models.EpisodeInfo>>
            {
                ["1"] = new List<Emby.M3uEditor.Plugin.Client.Models.EpisodeInfo>
                {
                    new Emby.M3uEditor.Plugin.Client.Models.EpisodeInfo { Id = 999, Season = 1, EpisodeNum = 1, ContainerExtension = "mp4" },
                }
            };
        ...
        public void ComputeSeriesEpisodeHash_DifferentExtension_DifferentHash()
        {
            ...
            var b = new Dictionary<string, List<Emby.M3uEditor.Plugin.Client.Models.EpisodeInfo>>
            {
                ["1"] = new List<Emby.M3uEditor.Plugin.Client.Models.EpisodeInfo>
                {
                    new Emby.M3uEditor.Plugin.Client.Models.EpisodeInfo { Id = 101, Season = 1, EpisodeNum = 1, ContainerExtension = "mkv" },
                }
            };
            Assert.NotEqual(StrmSyncService.ComputeSeriesEpisodeHash(a), StrmSyncService.ComputeSeriesEpisodeHash(b));
        }
        ...
        {
            var empty = new Dictionary<string, List<Emby.M3uEditor.Plugin.Client.Models.EpisodeInfo>>();
