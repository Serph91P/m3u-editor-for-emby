...
namespace Emby.M3uEditor.Plugin.Tests
{
    public class UpdateCheckerTests
    {
        ...
        public void ExtractDllDownloadUrl_FindsCorrectAsset()
        {
            var json = @"{
                ...
                ""assets"": [
                    ...
                    {
                        ""name"": ""Emby.M3uEditor.Plugin.dll"",
                        ""browser_download_url"": ""https://github.com/example/Emby.M3uEditor.Plugin.dll""
                    },
                    {
                        ""name"": ""README.md"",
            ...
            var url = UpdateChecker.ExtractDllDownloadUrl(json, "Emby.M3uEditor.Plugin.dll");
            Assert.Equal("https://github.com/example/Emby.M3uEditor.Plugin.dll", url);
        }
        ...
        {
            var url = UpdateChecker.ExtractDllDownloadUrl(null, "Emby.M3uEditor.Plugin.dll");
            Assert.Null(url);
        }
