...
{
    /// <summary>
    /// Tests for <see cref="M3uEditorTunerHost"/>.
    ///
    ...
    public class M3uEditorTunerHostTests
    {
        private static M3uEditorTunerHost MakeBareHost()
        {
            ...
            var host = (M3uEditorTunerHost)RuntimeHelpers.GetUninitializedObject(typeof(M3uEditorTunerHost));
        ...
        {
            var previousType = "xtr" + "eam-" + "tuner";
            ...
            Assert.Equal(M3uEditorTunerHost.StableTunerId, migrated.Id);
        ...
        public void ReconcileTunerHosts_UpgradeCollapsesDuplicatesAndPreservesExistingOptionsAndUnrelatedTuners()
        {
            ...
            var duplicate = new TunerHostInfo { Type = M3uEditorTunerHost.TunerType, Id = "duplicate-id" };
        ...
        public void ReconcileTunerHosts_DisabledOrMalformed_RemovesOnlyPluginTuners()
        {
            ...
            var malformed = new TunerHostInfo { Type = M3uEditorTunerHost.TunerType, Id = null };
            ...
            Assert.Same(unrelated, options.TunerHosts[0]);
            Assert.False(M3uEditorTunerHost.ReconcileTunerHosts(options, false));
        }
        ...
        public void ShouldClearWrongChannelArtworkAfterDetach_DefaultFlowPreservesArtwork()
        {
            ...
            Assert.False(M3uEditorTunerHost.ShouldClearWrongChannelArtworkAfterDetach(false, true));
        }

        [Fact]
        public void ShouldClearWrongChannelArtworkAfterDetach_RequiresExplicitRecoveryFlagAndConfigChange()
        {
            Assert.True(M3uEditorTunerHost.ShouldClearWrongChannelArtworkAfterDetach(true, true));
            Assert.False(M3uEditorTunerHost.ShouldClearWrongChannelArtworkAfterDetach(true, false));
        }
        ...
        public void ApplyChannelLogoVariants_DisabledLeavesLightLogosEmpty()
        {
            ...
            M3uEditorTunerHost.ApplyChannelLogoVariants(info, "https://example.com/logo.png", false);
        ...
        public void ApplyChannelLogoVariants_EmptyLogoClearsAllLogoUrls()
        {
            ...
            M3uEditorTunerHost.ApplyChannelLogoVariants(info, null, true);
