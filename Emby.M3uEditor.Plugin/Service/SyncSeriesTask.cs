...
namespace Emby.M3uEditor.Plugin.Service
{
    public class SyncSeriesTask : IScheduledTask
    {
        ...
        public SyncSeriesTask(ILogManager logManager)
            => _logger = logManager.GetLogger("M3uEditor.SyncSeriesTask");

        public string Name        => "m3u-editor for Emby - Sync Series";
        public string Description => "Sync series/TV show STRM files from the Xtream server.";
        public string Category    => "m3u-editor for Emby";
        public string Key         => "M3uEditorSyncSeries";
